...
export default function SettingsPage() {
  const { hasPermission, loading: checkingPermission } = usePermission()
  ...
  //         <p className="text-gray-600">You don't have permission to settings.</p>
  //         <p className="text-sm text-gray-500 mt-2">Required permission: <code className="bg-gray-100 px-2 py-1 rounded">setting</code></p>
  //       </div>
  //     </DashboardLayout>
  //   )
  // }
